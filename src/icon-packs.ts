...
const predefinedIconPacks = {
  ...
  iconBrew: {
    ...
    path: '',
    downloadLink:
      'https://github.com/himanshu-17lodhi/obsidian-iconize/raw/main/iconPacks/icon-brew.zip',
  },
  ...
  boxicons: {
    ...
    path: 'svg',
    downloadLink:
      'https://github.com/himanshu-17lodhi/obsidian-iconize/raw/main/iconPacks/boxicons.zip',
  },
  ...
  rpgAwesome: {
    ...
    path: '',
    downloadLink:
      'https://github.com/himanshu-17lodhi/obsidian-iconize/raw/main/iconPacks/rpg-awesome.zip',
  },
